...
<div>
    <form method="post" id="form_import" action="index.php?import=detail">
                    <div class="form_row">
                        <label style="color:white" class="col-sm-2 col-form-label" for="ID_CSM">ID Consignment:</label>
                        <input required class="form-control" type="text" id="ID_CSM" name="ID_CSM" placeholder="Ex: I1">
                    </div>
                    <div class="form_row"> 
                        <label style="color:white" class="col-sm-2 col-form-label" for="Date">Date:</label>
